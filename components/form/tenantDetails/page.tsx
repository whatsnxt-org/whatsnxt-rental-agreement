...
export const TenantDetails = ({ stepForward }: { stepForward: Function }) => {
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4 w-full h-3/4">
        <h2 className="text-2xl mt-12 font-medium md:hidden">Tenant Details</h2>
      ...
      <Button title="Next,Add Property Details" />
    </form>
  );
};
